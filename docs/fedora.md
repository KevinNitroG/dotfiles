...
| ------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `releaseRpms` | _(none on apt)_       | RPM Fusion free + nonfree, installed by URL. These ship their own `.repo` file **and** their gpg key, so a hand-written repo file would be wrong. |
